...
mixin _$ChecklistListState {
 ...
 ChecklistListStatus get status; List<ChecklistSummary> get items; String get query; FailureType? get failure; Event<ChecklistListEffect>? get effect;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(items),query,failure,effect);

@override
String toString() {
  return 'ChecklistListState(status: $status, items: $items, query: $query, failure: $failure, effect: $effect)';
}
...
@useResult
$Res call({
 ChecklistListStatus status, List<ChecklistSummary> items, String query, FailureType? failure, Event<ChecklistListEffect>? effect
});
...
/// Create a copy of ChecklistListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? items = null,Object? query = null,Object? failure = freezed,Object? effect = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ChecklistListStatus status,  List<ChecklistSummary> items,  String query,  FailureType? failure,  Event<ChecklistListEffect>? effect)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChecklistListState() when $default != null:
return $default(_that.status,_that.items,_that.query,_that.failure,_that.effect);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ChecklistListStatus status,  List<ChecklistSummary> items,  String query,  FailureType? failure,  Event<ChecklistListEffect>? effect)  $default,) {final _that = this;
switch (_that) {
case _ChecklistListState():
return $default(_that.status,_that.items,_that.query,_that.failure,_that.effect);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ChecklistListStatus status,  List<ChecklistSummary> items,  String query,  FailureType? failure,  Event<ChecklistListEffect>? effect)?  $default,) {final _that = this;
switch (_that) {
case _ChecklistListState() when $default != null:
return $default(_that.status,_that.items,_that.query,_that.failure,_that.effect);case _:
  return null;
...
class _ChecklistListState implements ChecklistListState {
  const _ChecklistListState({this.status = ChecklistListStatus.initial, final  List<ChecklistSummary> items = const <ChecklistSummary>[], this.query = '', this.failure, this.effect}): _items = items;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_items),query,failure,effect);
...
/// Create a copy of ChecklistListState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? items = null,Object? query = null,Object? failure = freezed,Object? effect = freezed,}) {
