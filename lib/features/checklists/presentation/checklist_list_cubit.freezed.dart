...
mixin _$ChecklistListState {
 ...
 ChecklistListStatus get status; List<ChecklistSummary> get items; String get query; bool get isRefreshing; FailureType? get failure; Event<ChecklistListEffect>? get effect;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(items),query,isRefreshing,failure,effect);

@override
String toString() {
  return 'ChecklistListState(status: $status, items: $items, query: $query, isRefreshing: $isRefreshing, failure: $failure, effect: $effect)';
}
...
@useResult
$Res call({
 ChecklistListStatus status, List<ChecklistSummary> items, String query, bool isRefreshing, FailureType? failure, Event<ChecklistListEffect>? effect
});
...
/// Create a copy of ChecklistListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? items = null,Object? query = null,Object? isRefreshing = null,Object? failure = freezed,Object? effect = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ChecklistListStatus status,  List<ChecklistSummary> items,  String query,  bool isRefreshing,  FailureType? failure,  Event<ChecklistListEffect>? effect)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChecklistListState() when $default != null:
return $default(_that.status,_that.items,_that.query,_that.isRefreshing,_that.failure,_that.effect);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ChecklistListStatus status,  List<ChecklistSummary> items,  String query,  bool isRefreshing,  FailureType? failure,  Event<ChecklistListEffect>? effect)  $default,) {final _that = this;
switch (_that) {
case _ChecklistListState():
return $default(_that.status,_that.items,_that.query,_that.isRefreshing,_that.failure,_that.effect);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ChecklistListStatus status,  List<ChecklistSummary> items,  String query,  bool isRefreshing,  FailureType? failure,  Event<ChecklistListEffect>? effect)?  $default,) {final _that = this;
switch (_that) {
case _ChecklistListState() when $default != null:
return $default(_that.status,_that.items,_that.query,_that.isRefreshing,_that.failure,_that.effect);case _:
  return null;
...
class _ChecklistListState implements ChecklistListState {
  const _ChecklistListState({this.status = ChecklistListStatus.initial, final  List<ChecklistSummary> items = const <ChecklistSummary>[], this.query = '', this.isRefreshing = false, this.failure, this.effect}): _items = items;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_items),query,isRefreshing,failure,effect);
...
/// Create a copy of ChecklistListState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? items = null,Object? query = null,Object? isRefreshing = null,Object? failure = freezed,Object? effect = freezed,}) {
